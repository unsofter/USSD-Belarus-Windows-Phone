...
namespace USSDManager
{
    ...
    {
        private static OperatorViewModel operatorModel = null;

        public static OperatorViewModel OperatorModel
        {
            get
            {
                // Отложить создание модели представления до необходимости
                if (operatorModel == null)
                    operatorModel = new OperatorViewModel();
        ...
        private void Application_Activated(object sender, ActivatedEventArgs e)
        {
            ...
            if (!App.OperatorModel.IsDataLoaded)
            {
        ...
        private void InitializeLanguage()
        {
            try
            {
                ...
                // файл ресурсов.
                RootFrame.Language = XmlLanguage.GetLanguage("ru");
